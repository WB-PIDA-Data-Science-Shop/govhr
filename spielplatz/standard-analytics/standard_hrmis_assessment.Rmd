...
### 3.4.3. Pay compression ratios in the public sector
...
contract_df |>
  ...
  pivot_wider(
    names_from = paygrade,
    values_from = base_salary_lcu_median,
    names_prefix = "paygrade_"
  ) |>
  mutate(
    pay_compression_ratio = paygrade_4 / paygrade_1
  ) |>
  ggplot_point_line(
    year,
    pay_compression_ratio
  ) +
  labs(
    x = "Year",
    y = "Pay Compression Ratio (Paygrade 4 / Paygrade 1)"
  )
```

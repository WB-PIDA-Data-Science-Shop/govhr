...
- **[Galileu Kim](https://github.com/galileukim)**. Author, maintainer.

- **[Ifeanyi Edochie](https://github.com/ifeanyi588)**. Author.

## Citation

Kim G, Edochie I (2026). *govhr: Clean and analyze data that informs
human resource management*. R package version 0.2.0,

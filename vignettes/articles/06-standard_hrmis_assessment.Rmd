...
data("bra_hrmis_personnel", package = "govhr")
data("bra_hrmis_est", package = "govhr")
...
# read-in data ------------------------------------------------------------
personnel_df <- bra_hrmis_personnel |>
  mutate(
    year = lubridate::year(ref_date)
  )

contract_df <- bra_hrmis_contract |>
  mutate(
    year = lubridate::year(ref_date)
  )

est_df <- bra_hrmis_est

...
```
    ...
    ## $ MATRICULA                         <chr> "11189", "165842", "37500", "124527"…
    ## $ CPF                               <chr> "9daf216845f5cc884941a9b94d08fedb01e…
    ## $ DATA_NASCIMENTO                   <chr> "19761", "31511", "21909", "26383", …
    ## $ GENERO                            <chr> "FEMININO", "FEMININO", "MASCULINO",…
    ## $ ESCOLARIDADE                      <chr> "1 A 4 SERIE DO PRIM. GRAU INCOMPLET…
    ## $ DATA_ADMISSAO                     <chr> "28580", "42425", "32113", "36530", …
    ## $ ADMINISTRACAO                     <chr> "INDIRETA", "INDIRETA", "INDIRETA", …
    ## $ TIPO_CONTRATO                     <chr> "INATIVO", "EFETIVO", "INATIVO", "PE…
    ## $ GRUPO                             <chr> NA, "SA⁄DE", NA, NA, NA, "EDUCAÇÃO",…
    ## $ COD_ORGAO                         <chr> NA, "404101", NA, NA, NA, "301800", …
    ## $ ORGAO                             <chr> "ALAGOAS PREVIDENCIA", "UNIVERSIDADE…
    ## $ CARREIRA                          <chr> NA, "ENFERMEIRO", NA, NA, NA, "PROFE…
    ## $ CARGO                             <chr> "AUXILIAR DE SERVICOS DIVERSOS", "EN…
    ## $ JORNADA                           <chr> NA, "30", NA, NA, NA, "0", NA, NA, N…
    ## $ CLASSE                            <chr> "D", "A", NA, NA, NA, NA, "B", NA, N…
    ## $ NIVEL                             <chr> "ACEND40", "ASSEA30", "NSP", "SDCOMB…
    ## $ DATA_ULT_PROGRESSAO               <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, …
    ## $ SALARIO_BASE                      <chr> NA, "R$4.173,43", NA, NA, NA, "1200"…
    ## $ CONTRIBUICAO_PREVIDENCIA          <chr> NA, "R$459,08", NA, NA, NA, "86.4", …
    ## $ ADICIONAL_TEMPO_SERVICO           <chr> NA, "R$-", NA, NA, NA, "0", NA, NA, …
    ## $ COMISSAO                          <chr> NA, "R$-", NA, NA, NA, "0", NA, NA, …
    ## $ ABONO_PERMANENCIA                 <chr> NA, "R$-", NA, NA, NA, "0", NA, NA, …
    ## $ DECISAO_JUDICIAL                  <chr> NA, "R$-", NA, NA, NA, "0", NA, NA, …
    ## $ DEMAIS_GRATIFICACOES_TRANSITORIAS <chr> NA, "R$1.114,48", NA, NA, NA, "0", N…
    ## $ DEMAIS_GRATIFICACOES_CARREIRA     <chr> NA, "R$-", NA, NA, NA, "0", NA, NA, …
    ## $ SALARIO_BRUTO                     <chr> NA, "R$5.287,91", NA, NA, NA, "1200"…
    ## $ SALARIO_LIQUIDO                   <chr> NA, "R$4.421,14", NA, NA, NA, "1113.…
    ## $ DATA_APOSENTADORIA                <chr> "39317", NA, "41548", NA, "42025", N…
    ## $ VALOR_BRUTO                       <chr> "R$954,00", NA, "6381.29", "R$3.854,…
    ## $ VALOR_LIQUIDO                     <chr> "R$954,00", NA, "6287.79", "R$3.623,…
...
| INATIVO                     | short-term    |
| EFETIVO                     | permanent     |
| PENSIONISTA                 | permanent     |
| TEMPORÁRIO                  | open-term     |
| EXCLUSIVAMENTE COMISSIONADO | short-term    |
| TEMPOR¡RIO                  | inactive      |
| EFETIVO COMISSIONADO        | retired       |

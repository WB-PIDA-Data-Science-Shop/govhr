...
contract_growth <- contract_df |> 
  ...
  mutate(year = lubridate::year(ref_date) |> as.integer()) |>
  dtplyr::lazy_dt() |> 
...
bra_wagebill |>
  ...
  compute_fastsummary(
    cols = wage_vars,
    group_cols = c("occupation_native", "year"),
    fns = "sum",
    output = "long"
  ) |>
  filter(
...
salary_dispersion <- contract_df |>
  ...
  compute_fastsummary(
    ...
    group_cols = c("occupation_isconame", "year"),
    fns = "median",
    output = "long"
  ) |> 
  ggplot_segment(

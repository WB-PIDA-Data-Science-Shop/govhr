...
#>  4 whours >= 0 & whours <= 168                           cont… working ho… Reas…
...
#>  8 gross_salary_lcu >= 0                                 wage… gross sala… Posi…
#>  9 base_salary_lcu >= 0                                  wage… base salar… Posi…
#> 10 net_salary_lcu >= 0                                   wage… net salary… Posi…
...
#>  3 gross_salary_lcu >= 0                                 wage… gross sala… Posi…
#>  4 base_salary_lcu >= 0                                  wage… base salar… Posi…
#>  5 net_salary_lcu >= 0                                   wage… net salary… Posi…
